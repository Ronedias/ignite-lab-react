...
export type GeteLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GeteLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug?: string | null }> };
...
export const GeteLessonsDocument = gql`
    query GeteLessons {
...
/**
 * __useGeteLessonsQuery__
 *
 * To run a query within a React component, call `useGeteLessonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGeteLessonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGeteLessonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGeteLessonsQuery(baseOptions?: Apollo.QueryHookOptions<GeteLessonsQuery, GeteLessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GeteLessonsQuery, GeteLessonsQueryVariables>(GeteLessonsDocument, options);
      }
export function useGeteLessonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GeteLessonsQuery, GeteLessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GeteLessonsQuery, GeteLessonsQueryVariables>(GeteLessonsDocument, options);
        }
export type GeteLessonsQueryHookResult = ReturnType<typeof useGeteLessonsQuery>;
export type GeteLessonsLazyQueryHookResult = ReturnType<typeof useGeteLessonsLazyQuery>;
export type GeteLessonsQueryResult = Apollo.QueryResult<GeteLessonsQuery, GeteLessonsQueryVariables>;